...
- Resolve overrides.test.ts type errors and CRLF bug (1d1f702)
- Raise engines.vscode to ^1.125.0 to match @types/vscode (994a9c9)
- Pin @types/vscode to engine to restore VSIX packaging (abc8675)
- Restore brace-expansion@2 override and vet guard by major (ab7809d)
...
- Document plugin update mechanism (d368b7b)
- State each override-guard rationale once in the header (13e1f6e)
...
- Merge duplicated guard predicates and aggregators (b7de904)
- Group guard helpers with the suites that prove them (6b7ea1a)
