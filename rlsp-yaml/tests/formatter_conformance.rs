...
const KNOWN_FAILURES: &[&str] = &[
    ...
    "6M2F[0]", "6PBE[0]", "6WLZ[0]", "6XDY[0]", "8KB6[0]", "98YD[0]", "9BXH[0]", "C4HZ[0]",
    "DK95[7]", "E76Z[0]", "FH7J[0]", "FTA2[0]", "HWV9[0]", "J7PZ[0]", "JEF9[1]", "JEF9[2]",
    "JHB9[0]", "KK5P[0]", "L383[0]", "M2N8[0]", "M2N8[1]", "M5DY[0]", "MUS6[0]", "MUS6[2]",
    "MUS6[3]", "MUS6[4]", "MUS6[5]", "MUS6[6]", "NB6Z[0]", "NKF9[0]", "PW8X[0]", "Q5MG[0]",
    "QT73[0]", "RZP5[0]", "S3PD[0]", "T26H[0]", "UGM3[0]", "UKK6[2]", "V9D5[0]", "W4TN[0]",
