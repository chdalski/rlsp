...
const KNOWN_FAILURES: &[&str] = &[
    "26DV[0]", "2G84[2]", "2G84[3]", "2XXW[0]", "35KP[0]", "3R3P[0]", "4QFQ[0]", "5GBF[0]",
    "5WE3[0]", "6CA3[0]", "6LVF[0]", "6M2F[0]", "6PBE[0]", "6SLA[0]", "6WLZ[0]", "6WPF[0]",
    "6XDY[0]", "6ZKB[0]", "7A4E[0]", "8KB6[0]", "98YD[0]", "9BXH[0]", "9DXL[0]", "9MQT[0]",
    "9TFX[0]", "C4HZ[0]", "CPZ3[0]", "DK95[7]", "DK95[8]", "E76Z[0]", "F6MC[0]", "FH7J[0]",
    "FTA2[0]", "G4RS[0]", "HWV9[0]", "J3BT[0]", "J7PZ[0]", "JEF9[1]", "JEF9[2]", "JHB9[0]",
    "K527[0]", "KK5P[0]", "KSS4[0]", "L383[0]", "M2N8[0]", "M2N8[1]", "M5DY[0]", "MJS9[0]",
    "MUS6[0]", "MUS6[2]", "MUS6[3]", "MUS6[4]", "MUS6[5]", "MUS6[6]", "NAT4[0]", "NB6Z[0]",
    "NKF9[0]", "NP9H[0]", "P2AD[0]", "PRH3[0]", "PW8X[0]", "Q5MG[0]", "Q8AD[0]", "QT73[0]",
    "R4YG[0]", "RZP5[0]", "S3PD[0]", "T26H[0]", "T4YY[0]", "TL85[0]", "TS54[0]", "UGM3[0]",
    "UKK6[2]", "V9D5[0]", "W4TN[0]", "WZ62[0]", "X38W[0]", "XW4D[0]", "Y79Y[1]",
];
...
mod tests {
    ...
    fn allowlist_known_failure_matches_by_exact_key() {
        // G4RS[0] is in KNOWN_FAILURES.
        assert!(is_known_failure("G4RS[0]"));
    }
