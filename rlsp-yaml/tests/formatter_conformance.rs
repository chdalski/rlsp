...
const KNOWN_FAILURES: &[&str] = &[
    "26DV[0]", "2G84[2]", "2G84[3]", "6CA3[0]", "6M2F[0]", "6PBE[0]", "8KB6[0]", "98YD[0]",
    "9BXH[0]", "E76Z[0]", "FH7J[0]", "FTA2[0]", "HWV9[0]", "KK5P[0]", "M2N8[0]", "NKF9[0]",
    "PW8X[0]", "Q5MG[0]", "QT73[0]", "RZP5[0]", "S3PD[0]", "T26H[0]", "UGM3[0]", "UKK6[2]",
    "W4TN[0]", "XW4D[0]",
];
