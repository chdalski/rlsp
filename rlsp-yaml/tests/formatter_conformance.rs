...
const KNOWN_FAILURES: &[&str] = &[
    ...
    "FH7J[0]", "FTA2[0]", "HWV9[0]", "J7PZ[0]", "JHB9[0]", "KK5P[0]", "L383[0]", "M2N8[0]",
    "MUS6[2]", "MUS6[3]", "MUS6[4]", "MUS6[5]", "MUS6[6]", "NKF9[0]", "PW8X[0]", "Q5MG[0]",
    "QT73[0]", "RZP5[0]", "S3PD[0]", "T26H[0]", "UGM3[0]", "UKK6[2]", "W4TN[0]", "XW4D[0]",
];
