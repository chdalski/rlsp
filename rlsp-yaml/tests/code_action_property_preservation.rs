...
use rstest::rstest;
use tower_lsp::lsp_types::{Diagnostic, NumberOrString, Position, Range, TextEdit, Url};

// ---- Helpers (re-implemented locally; code_action_fixtures.rs helpers are pub(super)) ----
